...
class App extends Component {
  ...
  renderGame = () => {
    const {timeInSec, isGameOver, guessImageUrl, activeTabId} = this.state
    const FilteredImages = this.getFilteredImages()
    if (timeInSec !== 0 && isGameOver === false) {
      return (
        <>
          <div className="images-container">
            <img src={guessImageUrl} alt="match" className="single-img" />
    ...
    return <ScoreCard onReloadGame={this.onReloadGame} score={score} />
  }
  ...
  render() {
    const {timeInSec, score} = this.state
          ...
          <li>
            <div className="text-container">
              <p className="header-text">
                Score: <span className="score-timer-text">{score}</span>
              </p>
              <div className="timer-logo-time-container">
                <img
                  src="https://assets.ccbp.in/frontend/react-js/match-game-timer-img.png"
                  alt="timer"
                  className="timer-icon"
                />
                <p className="score-timer-text">{timeInSec} Sec</p>
              </div>
            </div>
          </li>
        </ul>
